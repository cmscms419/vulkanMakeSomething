...
namespace vkengine
{
    ...
    VKCommandBufferHander::VKCommandBufferHander(VkDevice &device, VkCommandBuffer handle, VkCommandPool &commandPool, VkQueue &queue)
    ...
    VKCommandBufferHander::VKCommandBufferHander(VKCommandBufferHander &&other) noexcept
    ...
    VKCommandBufferHander::~VKCommandBufferHander()
    {
        cleanup();
    }
    ...
    VkCommandPool &VKCommandBufferHander::getCommandPool() { return commandPool; }
    VkQueue &VKCommandBufferHander::getQueue() { return queue; }
    VkCommandBuffer &VKCommandBufferHander::getCommandBuffer() { return handle; }
