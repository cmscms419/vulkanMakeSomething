...
namespace vkengine {
    void VKPipeLineHandle::createPostProcessingPipeLine(
        VkFormat outColorFormat,
        VkFormat depthFormat,
        VkSampleCountFlagBits msaaSamples
    )
    {
        // pipeline_ 생성 postprocessing 생성 해야함
        ...
        vertexInputBindingDesc[0].stride = 0;
        ...
        vertexInputStateCI.vertexBindingDescriptionCount = 0;      // 0으로 설정!
