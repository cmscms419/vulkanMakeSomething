...
namespace vkengine
{
    ...
    VkExtent2D VKSwapChain::getWindowSize() const { return this->windowSize; }
    VkFormat VKSwapChain::getSwapChainImageFormat() const { return this->ImageFormat; }
    VkSwapchainKHR &VKSwapChain::getSwapChain() { return this->swapChain; }
    std::vector<VkImage> &VKSwapChain::getSwapChainImages() { return this->Images; }
    std::vector<VkImageView> &VKSwapChain::getSwapChainImageViews() { return this->ImageViews; }
    cUint32_t VKSwapChain::getSwapChainImageCount() const { return static_cast<cUint32_t>(this->Images.size()); }
        ...
        : ctx(ctx), surface(surface), windowSize(windowSize)
    {
        ...
        selectPresentMode = VK_PRESENT_MODE_MAX_ENUM_KHR;
        imageCount = 0;
        capabilities = {};
    ...
    VkImage &VKSwapChain::getSwapChainImage(cUint32_t imageindex)
    {
    ...
    VkImageView &VKSwapChain::getSwapChainImageView(cUint32_t imageindex)
    {
    ...
    VkResult VKSwapChain::acquireNextImage(VkSemaphore presentCompleteSemaphore, cUint32_t &imageIndex) const
    {
    ...
    VkImage VKSwapChain::Image(cUint32_t index)
    {
    ...
    VkImageView VKSwapChain::ImageView(cUint32_t index)
    {
    ...
    VkSurfaceKHR &VKSwapChain::Surface()
    {
        return this->surface;
    }

    cUint32_t VKSwapChain::ImageCount() const
    {
        return this->imageCount;
    }

    std::vector<VkImageView> &VKSwapChain::AllImageViews()
    {
        return this->ImageViews;
    }

    std::vector<VkImage> &VKSwapChain::AllImages()
    {
        return this->Images;
    }

    VKBarrierHelper &VKSwapChain::getBarrierHelper(cUint32_t imageIndex)
    {
