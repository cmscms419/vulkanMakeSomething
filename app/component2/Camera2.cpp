...
namespace vkengine
{
    namespace object
    {
        ...
        void Camera2::RotateScreenStandard(cFloat xpos, cFloat ypos, int windowWidth, int windowHeight)
        {
            // 마우스 커서의 위치를 NDC로 변환
        ...
        void Camera2::setOrthographicProjection(cFloat left, cFloat right, cFloat top, cFloat bottom, cFloat nearP, cFloat farP)
        {
            this->left = left;
            this->right_ = right;
            this->top = top;
        ...
        void Camera2::setPerspectiveProjection()
        {
        ...
        void Camera2::setOrthographicProjection()
        {
        ...
        void Camera2::setViewDirection(cVec3 pos, cVec3 dir, cVec3 up)
        {
        ...
        void Camera2::setViewTarget(cVec3 pos, cVec3 target, cVec3 up)
        {
            setViewDirection(pos, target - pos, up);
        }

        void Camera2::setViewXYZ(cVec3 pos, cVec3 rot)
        {
