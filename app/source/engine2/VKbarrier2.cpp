...
namespace vkengine {
    VkCommandBuffer VKBarrierHelper::beginSingleTimeCommands2(VkDevice device, VkCommandPool commandPool, VkCommandBufferLevel level)
    {
        ...
        cUint32_t layerCount)
    {
        ...
        barrier2.subresourceRange = {
            getAspectFlagsFromLayout(format),           // 이미지의 어떤 부분(색상, 깊이 등)에 영향을 미칠지 정의
