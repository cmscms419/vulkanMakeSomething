...
namespace vkengine {
    ...
    void LightEngine::createDescriptorSetLayout()
    {
    ...
    void LightEngine::createDescriptorPool()
    {
        //// 디스크립터 풀 크기를 설정합니다.
    ...
    void LightEngine::createDescriptorSets()
    {
    ...
    void LightEngine::createGraphicsPipeline()
    {
    ...
    void LightEngine::createGraphicsPipeline2()
    {
    ...
    void LightEngine::updateUniformBuffer(uint32_t currentImage)
    {
