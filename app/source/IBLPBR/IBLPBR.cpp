...
namespace vkengine {
    iblpbrEngube::iblpbrEngube(std::string root_path) : VulkanEngine(root_path) {}

    iblpbrEngube::~iblpbrEngube() {}

    void iblpbrEngube::init()
    {
        VulkanEngine::init();
        this->camera = std::make_shared<vkengine::object::Camera>();
    }

    bool iblpbrEngube::prepare()
    {
    ...
    void iblpbrEngube::update(float dt)
    {
    ...
    bool iblpbrEngube::init_sync_structures()
    {
    ...
    void iblpbrEngube::recordCommandBuffer(FrameData* framedata, uint32_t imageIndex)
    {
        // 커맨드 버퍼 기록을 시작합니다.
    ...
    void iblpbrEngube::createVertexbuffer()
    {
    ...
    void iblpbrEngube::createIndexBuffer()
    {
    ...
    void iblpbrEngube::createUniformBuffers()
    {
    ...
    void iblpbrEngube::createDescriptor()
    {
    ...
    void iblpbrEngube::createGraphicsPipeline()
    {
    ...
    void iblpbrEngube::createGraphicsPipeline_skymap()
    {
