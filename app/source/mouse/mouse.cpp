...
namespace vkengine {
    ...
    MouseControllEngine::MouseControllEngine(std::string root_path) : VulkanEngine(root_path) {}
    MouseControllEngine::~MouseControllEngine() {}
    void MouseControllEngine::init()
    {
        VulkanEngine::init();
        this->camera = std::make_shared<vkengine::object::Camera>();
    }
    bool MouseControllEngine::prepare()
    {
        ...
        for (auto& path : pathArray)
        {
            ...
            this->cubeObject->setTexturePNG(resourcePNG);
    ...
    void MouseControllEngine::cleanup()
    {
    ...
    void MouseControllEngine::drawFrame()
    {
    ...
    bool MouseControllEngine::mainLoop()
    {
    ...
    bool MouseControllEngine::init_sync_structures()
    {
    ...
    void MouseControllEngine::recordCommandBuffer(FrameData* framedata, uint32_t imageIndex)
    {
        // 커맨드 버퍼 기록을 시작합니다.
    ...
    void MouseControllEngine::createDescriptorSetLayout()
    {
    ...
    void MouseControllEngine::createDescriptorPool()
    {
        //// 디스크립터 풀 크기를 설정합니다.
    ...
    void MouseControllEngine::createGraphicsPipeline()
    {
    ...
    void MouseControllEngine::createGraphicsPipeline2()
    {
    ...
    void MouseControllEngine::updateUniformBuffer(uint32_t currentImage)
    {
    ...
    void MouseControllEngine::cleanupSwapcChain()
    {
