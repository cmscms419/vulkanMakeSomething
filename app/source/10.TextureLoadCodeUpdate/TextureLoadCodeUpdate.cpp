#include "TextureLoadCodeUpdate.h"
...
namespace vkengine {
    ...
    TextureLoadCodeUpdateEngine::TextureLoadCodeUpdateEngine(std::string root_path) : VulkanEngine(root_path) {}

    TextureLoadCodeUpdateEngine::~TextureLoadCodeUpdateEngine() {}

    void TextureLoadCodeUpdateEngine::init()
    {
        VulkanEngine::init();
        this->camera = std::make_shared<vkengine::object::Camera>();
    }

    bool TextureLoadCodeUpdateEngine::prepare()
    {
    ...
    void TextureLoadCodeUpdateEngine::cleanup()
    {
    ...
    void TextureLoadCodeUpdateEngine::drawFrame()
    {
    ...
    bool TextureLoadCodeUpdateEngine::mainLoop()
    {
    ...
    void TextureLoadCodeUpdateEngine::update(float dt)
    {
    ...
    bool TextureLoadCodeUpdateEngine::init_sync_structures()
    {
    ...
    void TextureLoadCodeUpdateEngine::recordCommandBuffer(FrameData* framedata, uint32_t imageIndex)
    {
        // 커맨드 버퍼 기록을 시작합니다.
    ...
    void TextureLoadCodeUpdateEngine::createVertexbuffer()
    {
    ...
    void TextureLoadCodeUpdateEngine::createIndexBuffer()
    {
    ...
    void TextureLoadCodeUpdateEngine::createUniformBuffers()
    {
    ...
    void TextureLoadCodeUpdateEngine::createGraphicsPipeline()
    {
    ...
    void TextureLoadCodeUpdateEngine::createGraphicsPipeline2()
    {
        VkShaderModule baseVertshaderModule = this->VKdevice->createShaderModule(this->RootPath + "../../../../../../shader/vertloadmodel.spv");
        VkShaderModule baseFragShaderModule = this->VKdevice->createShaderModule(this->RootPath + "../../../../../../shader/fragloadmodel2.spv");
    ...
    void TextureLoadCodeUpdateEngine::createGraphicsPipeline_skymap()
    {
    ...
    void TextureLoadCodeUpdateEngine::cleanupSwapcChain()
    {
    ...
    void TextureLoadCodeUpdateEngine::initUI()
    {
