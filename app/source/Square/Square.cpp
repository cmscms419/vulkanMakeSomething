...
namespace vkengine {
    square::square(std::string root_path) : VulkanEngine(root_path) {}
    square::~square() {}
    ...
    bool square::init_sync_structures()
    {
    ...
    void square::recordCommandBuffer(FrameData* framedata, uint32_t imageIndex)
    {
        // 커맨드 버퍼 기록을 시작합니다.
    ...
    void square::createVertexbuffer()
    {
    ...
    void square::createUniformBuffers()
    {
    ...
    void square::createDescriptorSetLayout()
    {
    ...
    void square::createDescriptorPool()
    {
        //// 디스크립터 풀 크기를 설정합니다.
    ...
    void square::createDescriptorSets()
    {
    ...
    void square::createGraphicsPipeline()
    {
        VkShaderModule baseVertshaderModule = this->VKdevice->createShaderModule(this->RootPath + "../../../../../../shader/vertSquare.spv");
        VkShaderModule baseFragShaderModule = this->VKdevice->createShaderModule(this->RootPath + "../../../../../../shader/fragSquare.spv");
    ...
    void square::updateUniformBuffer(uint32_t currentImage)
    {
