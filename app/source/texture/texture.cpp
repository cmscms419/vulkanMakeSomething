...
namespace vkengine {
    TextureEngine::TextureEngine(std::string root_path) : VulkanEngine(root_path) {}
    ...
    void TextureEngine::update(float dt)
    {
    ...
    bool TextureEngine::init_sync_structures()
    {
    ...
    void TextureEngine::recordCommandBuffer(FrameData* framedata, uint32_t imageIndex)
    {
        // 커맨드 버퍼 기록을 시작합니다.
    ...
    void TextureEngine::createUniformBuffers()
    {
    ...
    void TextureEngine::createDescriptorSetLayout()
    {
    ...
    void TextureEngine::createDescriptorSets()
    {
    ...
    {
        VkShaderModule baseVertshaderModule = this->VKdevice->createShaderModule(this->RootPath + "../../../../../../shader/vertTexture.spv");
        VkShaderModule baseFragShaderModule = this->VKdevice->createShaderModule(this->RootPath + "../../../../../../shader/fragTexture.spv");
    ...
    void TextureEngine::updateUniformBuffer(uint32_t currentImage)
    {
    ...
    void TextureEngine::cleanupSwapcChain()
    {
