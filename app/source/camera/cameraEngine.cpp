...
namespace vkengine {
    ...
    void cameraEngine::update(float dt)
    {
        ...
        this->camera->update();
        this->camera->setPerspectiveProjection(45.0f, static_cast<float>(this->VKswapChain->getSwapChainExtent().width) / static_cast<float>(VKswapChain->getSwapChainExtent().height), 0.1f, 100.0f);
    }
