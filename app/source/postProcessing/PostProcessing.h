...
class Ex11_PostProcessingExample
{
  ...
  private:
    ...
    const cString kAssetsPathPrefix = "../../assets/";
    const cString kShaderPathPrefix = kAssetsPathPrefix + "shaders/";
    ...
    VKShaderManager shaderManager_;
    //GuiRenderer guiRenderer_;

    // Frame resources
    std::vector<VKCommandBufferHander> commandBuffers_;
    ...
    // Camera
    vkengine::object::Camera2 camera;
